...
const failures = [];
if (sourceProductCount !== 230) failures.push(`esperados 230 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 141) failures.push(`esperados 141 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 141, affiliateLinks: links.length, realImages: imageCount }, null, 2));
