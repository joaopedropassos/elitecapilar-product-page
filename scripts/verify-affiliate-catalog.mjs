...
const failures = [];
if (sourceProductCount !== 233) failures.push(`esperados 233 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 144) failures.push(`esperados 144 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 144, affiliateLinks: links.length, realImages: imageCount }, null, 2));
