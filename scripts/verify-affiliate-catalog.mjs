...
const failures = [];
if (sourceProductCount !== 284) failures.push(`esperados 284 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 195) failures.push(`esperados 195 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 195, affiliateLinks: links.length, realImages: imageCount }, null, 2));
