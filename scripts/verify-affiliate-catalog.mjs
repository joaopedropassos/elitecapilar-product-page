...
const failures = [];
if (sourceProductCount !== 258) failures.push(`esperados 258 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 169) failures.push(`esperados 169 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 169, affiliateLinks: links.length, realImages: imageCount }, null, 2));
