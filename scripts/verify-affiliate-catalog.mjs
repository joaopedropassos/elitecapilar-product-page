...
const failures = [];
if (sourceProductCount !== 307) failures.push(`esperados 307 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 218) failures.push(`esperados 218 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 218, affiliateLinks: links.length, realImages: imageCount }, null, 2));
