...
const failures = [];
if (sourceProductCount !== 247) failures.push(`esperados 247 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 158) failures.push(`esperados 158 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 158, affiliateLinks: links.length, realImages: imageCount }, null, 2));
