...
const failures = [];
if (sourceProductCount !== 364) failures.push(`esperados 364 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 275) failures.push(`esperados 275 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 275, affiliateLinks: links.length, realImages: imageCount }, null, 2));
