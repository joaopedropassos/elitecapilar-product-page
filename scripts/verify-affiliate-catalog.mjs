...
const failures = [];
if (sourceProductCount !== 382) failures.push(`esperados 382 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 293) failures.push(`esperados 293 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 293, affiliateLinks: links.length, realImages: imageCount }, null, 2));
