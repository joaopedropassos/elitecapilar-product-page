...
const failures = [];
if (sourceProductCount !== 265) failures.push(`esperados 265 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 176) failures.push(`esperados 176 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 176, affiliateLinks: links.length, realImages: imageCount }, null, 2));
