...
const failures = [];
if (sourceProductCount !== 169) failures.push(`esperados 169 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 80) failures.push(`esperados 80 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 80, affiliateLinks: links.length, realImages: imageCount }, null, 2));
