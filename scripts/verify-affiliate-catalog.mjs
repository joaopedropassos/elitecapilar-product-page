...
const failures = [];
if (sourceProductCount !== 290) failures.push(`esperados 290 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 201) failures.push(`esperados 201 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 201, affiliateLinks: links.length, realImages: imageCount }, null, 2));
