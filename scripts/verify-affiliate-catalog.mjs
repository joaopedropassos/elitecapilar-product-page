...
const failures = [];
if (sourceProductCount !== 270) failures.push(`esperados 270 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 181) failures.push(`esperados 181 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 181, affiliateLinks: links.length, realImages: imageCount }, null, 2));
