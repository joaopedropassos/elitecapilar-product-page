...
const failures = [];
if (sourceProductCount !== 324) failures.push(`esperados 324 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 235) failures.push(`esperados 235 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 235, affiliateLinks: links.length, realImages: imageCount }, null, 2));
