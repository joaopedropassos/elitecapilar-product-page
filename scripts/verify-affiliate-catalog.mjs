...
const failures = [];
if (sourceProductCount !== 330) failures.push(`esperados 330 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 241) failures.push(`esperados 241 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 241, affiliateLinks: links.length, realImages: imageCount }, null, 2));
