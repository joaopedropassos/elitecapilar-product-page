...
const failures = [];
if (sourceProductCount !== 356) failures.push(`esperados 356 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 267) failures.push(`esperados 267 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 267, affiliateLinks: links.length, realImages: imageCount }, null, 2));
