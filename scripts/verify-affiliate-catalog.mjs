...
const failures = [];
if (sourceProductCount !== 231) failures.push(`esperados 231 produtos editoriais na fonte, encontrados ${sourceProductCount}`);
if (links.length !== 142) failures.push(`esperados 142 links, encontrados ${links.length}`);
...
console.log(JSON.stringify({ ok: true, sourceProductCount, renderedLinkedProducts: 142, affiliateLinks: links.length, realImages: imageCount }, null, 2));
